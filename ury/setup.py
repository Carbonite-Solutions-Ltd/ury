...
def get_custom_fields():
	...
	return {
     	...
     	"POS Invoice": [
				...
				{
					# Delete vs Cancel (2026-09-19). Cancel asks the kitchen first;
					# Delete is a manager's call that skips the kitchen entirely.
					# A deleted order is kept (cancelled, not erased) so the kitchen's
					# Deleted list and the desk can still show who, when and why.
					"fieldname": "custom_deleted",
					"fieldtype": "Check",
					"label": "Deleted",
					"insert_after": "custom_on_account_sms_sent",
					"default": "0",
					"allow_on_submit": 1,
					"no_copy": 1,
					"read_only": 1,
					"print_hide": 1,
					"in_standard_filter": 1,
					"description": "1 when a manager deleted this order outright instead of cancelling it. A deleted order is cancelled without asking the kitchen: its tickets leave the kitchen screen and show on the kitchen's Deleted list. The reason is in Cancel Reason.",
					"translatable": 0,
				},
				{
					"fieldname": "custom_deleted_by",
					"fieldtype": "Link",
					"options": "User",
					"label": "Deleted By",
					"insert_after": "custom_deleted",
					"depends_on": "eval:doc.custom_deleted",
					"allow_on_submit": 1,
					"no_copy": 1,
					"read_only": 1,
					"print_hide": 1,
				...
				{
					"fieldname": "custom_deleted_at",
					"fieldtype": "Datetime",
					"label": "Deleted At",
					"insert_after": "custom_deleted_by",
					"depends_on": "eval:doc.custom_deleted",
					"allow_on_submit": 1,
					"no_copy": 1,
					"read_only": 1,
